...
<div id="AdminScreen">
	...
	<li class="caption">个人信息管理		
		<ol>
			...
			<li class="current"><a href="Blog/userSettings">网页个性设置</a></li>
		</ol>
	</li>		
</ul>
<ul>
...
<form id="style_form" action="Blog/update_userSettings" method="POST">
<h2 class="title">网页个性化设置</h2>
<table>
	<tbody>
		<tr>
		<th>我的心情</th>		
		<td><input name="space_name" size="40" maxlength="40" class="TEXT" value="<?php echo $myMOOD[0]->MOOD;?>" type="text"></td>
	</tr>
	<tr><th></th><td></td></tr>
	<tr class="submit">
		<th></th>	
	...
	<div class="clear"></div>
	<div id="OSC_Footer">© 赛斯特(WWW.SYSIT.ORG)<?php var_dump($myMOOD); ?></div>
</div>
</body></html>