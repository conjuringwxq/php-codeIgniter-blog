...
<html xml:lang="zh-CN" xmlns="http://www.w3.org/1999/xhtml" lang="zh-CN"><head>
  ...
  <title>发表博客 <?php echo $this->session->userdata('uname');?>的博客 - SYSIT个人博客</title>
...
<ul>
    ...
    <div id="AdminContent">
<div class="MainForm">
<form id="BlogForm" action="Blog/do_add" method="POST">
<input id="hdn_blog_id" name="draft" value="0" type="hidden">
  ...
  <tr class="option">
	...
	<input id="blog_type_4" name="type" value="转帖" onclick="switch_src(this)" type="radio"> <label for="blog_type_1">转贴&nbsp;</label>
