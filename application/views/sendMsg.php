...
<html xmlns="http://www.w3.org/1999/xhtml"><head>
    ...
    <title>发送留言 -  <?php echo $this->session->userdata('uname');?>的博客 - SYSIT个人博客</title>
    ...
    <div id="OSC_Content"><div class="SpaceChannel">
            ...
            <div id="lnks">
                ...
                <div>
                    ...
                    <a href="javascript:window.location.reload()">发送留言</a>
                    </span>
                </div>
            </div>
            <div class="clear"></div>
        ...
        <div class="Blog">
            <div style="width: auto; height: auto; overflow: auto; position: relative;"><style>
                ...
                <div id="AjaxBox">
                    <h2 id="Title">发送留言给 <u><?php echo $sendTo->NAME;?></u></h2>
                    <div id="Content"><div id="s_error_msg" class="error_msg"></div>
                        <div id="s_success_msg" class="success_msg"></div>
                        <form id="frm_sendmsg" action="Message/do_sendMsg?id=<?php echo $sendTo->RECEIVER;?>" method="POST">
                            <table>
