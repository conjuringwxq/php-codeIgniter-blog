...
<ul>
  ...
  <li class="Blog" id="blog_24027">
	<h2 class="BlogAccess_true BlogTop_0"><a href="Blog/viewPost_comment"><?php echo $val->TITLE?></a></h2>
	<div class="outline">
	  ...
	  <span class="stat">统计: <?php echo $val->COMM_RATE?>评/<?php echo $val->CLICK_RATE?>阅</span>
	  	  <span class="blog_admin">( <a href="Blog/newBlog">修改</a> | <a href="javascript:delete_blog(24027)">删除</a> )</span>	  
	  	</div>
...
<div class="comments SpaceModule">
  <strong>最新网友评论</strong>
      <ul>
		<li>
		<span class="u"><a href="#"><img src="images/portrait.gif" alt="<?php echo $this->session->userdata('uname');?>" title="<?php echo $this->session->userdata('uname');?>" class="SmallPortrait" user="154693" align="absmiddle"></a></span>
		<span class="c">hoho
